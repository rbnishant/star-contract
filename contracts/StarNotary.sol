...
contract StarNotary is ERC721 {
    ...
    string public constant name = "ROSHI";
    string public constant symbol = "ROSHI";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require((user1 == msg.sender || user2 == msg.sender), "You can't exchange the Star you don't owned");
